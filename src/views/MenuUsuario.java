...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		btnInicio.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnInicio.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
		...
		btnInicio.setBounds(10, 379, 257, 56);
		btnInicio.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnBuscar);
		...
		btnInicio.setLayout(null);
		btnInicio.setBackground(new Color(12, 138, 199));
		btnInicio.setBounds(0, 379, 257, 56);
		panelMenu.add(btnInicio);
		
		JLabel lblInicio = new JLabel("Salir");
		lblInicio.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/cerrar_sesion.png")));
		lblInicio.setHorizontalAlignment(SwingConstants.LEFT);
		lblInicio.setForeground(Color.WHITE);
		lblInicio.setFont(new Font("Dialog", Font.PLAIN, 18));
		lblInicio.setBounds(27, 11, 200, 34);
