...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		separator_1_2.setBounds(75, 195, 289, 2);
		...
		separator_1_3.setBounds(75, 453, 289, 2);
		panel.add(separator_1_3);
		
		JSeparator separator_1_1 = new JSeparator();
		separator_1_1.setForeground(SystemColor.textHighlight);
		separator_1_1.setBounds(75, 281, 289, 11);
		...
		txtFechaE.setBounds(75, 161, 289, 35);
		...
		txtFechaE.setMinSelectableDate(new Date() ); //desabilitamos los dias anteriores al actual
		panel.add(txtFechaE);
		...
		txtFechaS.setBounds(75, 246, 289, 35);
		...
		txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
			...
			private void Calculavalor() {
				...
				if(txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
					long diferencia = txtFechaS.getDate().getTime() - txtFechaE.getDate().getTime();
					long diasdediferencia = TimeUnit.DAYS.convert(diferencia,TimeUnit.MILLISECONDS);
					NumberFormat formatoImporte = NumberFormat.getCurrencyInstance();
					double valordias = new BigDecimal(diasdediferencia).intValueExact() * costodias;
					if(valordias <= 0) {
						txtFechaE.setCalendar(null);
						txtFechaS.setCalendar(null);
						JOptionPane.showConfirmDialog(null, "Seleccione una fecha correcta");
						return;	
					}
					txtValor.setText(formatoImporte.format(valordias));
					System.out.println(formatoImporte.format(valordias));
		...
		txtValor.setBackground(SystemColor.white);
		txtValor.setHorizontalAlignment(SwingConstants.CENTER);
		txtValor.setForeground(Color.black);
		txtValor.setBounds(130, 328, 120, 33);
		...
		lblValor.setBounds(75, 303, 196, 14);
		lblValor.setFont(new Font("Roboto Black", Font.PLAIN, 16));
		panel.add(lblValor);
		
		txtFormaPago = new JComboBox();
		txtFormaPago.setBounds(75, 417, 289, 38);
		...
		lblFormaPago.setBounds(75, 382, 187, 24);
		...
		separator_1.setBounds(75, 362, 289, 2);
		...
		JPanel btnsBorrar = new JPanel();
		btnsBorrar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				txtFechaS.setCalendar(null);
				txtFechaE.setCalendar(null);
		...
		btnsBorrar.setLayout(null);
		btnsBorrar.setBackground(SystemColor.textHighlight);
		btnsBorrar.setBounds(75, 493, 122, 35);
		panel.add(btnsBorrar);
		btnsBorrar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));

		
		JLabel lblnclear = new JLabel("BORRAR");
		lblnclear.setBounds(0, 0, 122, 35);
		btnsBorrar.add(lblnclear);
		 lblnclear.setForeground(SystemColor.controlLtHighlight);
		 lblnclear.setHorizontalAlignment(SwingConstants.CENTER);
		 lblnclear.setFont(new Font("Roboto", Font.PLAIN, 18));
	...
	//CODIGO PARA CALCULAR EL VLOR DE LOS DIAS SEGUNDA OPCION
